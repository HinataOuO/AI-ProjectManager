...
- Output Markdown plan files under `.pi/ai-project/local/project/roadmap/plans/R1/` named `R1.1.md`, `R1.2.md`, and so on.
...
4. For each task, create the next `R1.x.md` file in `.pi/ai-project/local/project/roadmap/plans/R1/`.
...
## done
- Plan files exist in `.pi/ai-project/local/project/roadmap/plans/R1/`.
